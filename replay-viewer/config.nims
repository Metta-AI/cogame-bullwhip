...
switch(
  "passL",
  (&"""
  -o {distDir / "bullwhip_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=BullwhipReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_bw_load_replay,_bw_payload_ptr,_bw_payload_len,_bw_error_ptr,_bw_error_len
  """).replace("\n", " ")
)
