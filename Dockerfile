# Bullwhip game + player image. One image, two entrypoints:
...
WORKDIR /workspace/bullwhip
COPY --from=build /workspace/bullwhip/bullwhip /bin/bullwhip
COPY --from=build /workspace/bullwhip/bullwhip-player /bin/bullwhip-player
COPY --from=build /workspace/bullwhip/data ./data
COPY --from=build /workspace/bullwhip/client ./client
