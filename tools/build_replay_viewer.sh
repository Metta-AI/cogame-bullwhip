...
test -s "${dist}/bullwhip_replay.wasm"
test -s "${dist}/bullwhip_replay.js"

rm -rf "${output_dir}"
mkdir -p "${output_dir}/assets"
cp "${dist}/bullwhip_replay.js" "${dist}/bullwhip_replay.wasm" "${output_dir}/"
...
echo "bullwhip replay viewer bundle: ${output_dir}"
